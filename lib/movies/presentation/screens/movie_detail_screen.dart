...
import 'package:movie/movies/presentation/controller/movie_details_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) {
        final bloc = servicesLocator<MovieDetailsBloc>();
        bloc.add(GetMovieDetailsEvent(id));
        bloc.add(GetRecommendationEvent(id));
        return bloc;
      },
